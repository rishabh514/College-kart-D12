...
// Utility Functions to get initials and color
...
                                        alt="Profile"
                                        className="w-32 h-32 rounded-full object-cover border-4 border-zinc-700 cursor-pointer"
                                        onClick={handlePhotoClick}
                                    />
                                ) : (
                                    <div
                                        className="w-32 h-32 rounded-full border-4 border-zinc-700 flex items-center justify-center cursor-pointer"
                                        onClick={handlePhotoClick}
                                        style={{
                                            background: getRandomColor(getInitials(formData.firstName, formData.lastName)),
                                            color: "#fff",
                                            fontSize: "2.5rem",
                                            fontWeight: "bold",
                                            userSelect: "none"
